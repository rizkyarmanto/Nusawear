    ...
    <>
        ...
        <div className="container py-14 md:py-24 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="mt-4 text-4xl md:text-6xl font-extrabold leading-tight tracking-tight">
              Baju Kasual Premium untuk{" "}
              <span className="text-primary">Setiap Hari</span>
            </h1>
            <p className="mt-4 text-muted-foreground md:text-lg max-w-prose">
              Didesain dengan pendekatan product design modern, fokus pada
              kenyamanan, ketahanan, dan pengalaman digital yang mulus dari
              browsing hingga checkout.
            </p>
            ...
            <div className="mt-8 grid grid-cols-3 gap-4 text-sm">
              <div className="rounded-lg border p-3">
                <div className="font-semibold">220 GSM</div>
                <div className="text-muted-foreground">
                  Kain tebal berstruktur
                </div>
              </div>
              <div className="rounded-lg border p-3">
                <div className="font-semibold">Enzyme Wash</div>
                <div className="text-muted-foreground">
                  Lembut dan tahan susut
                </div>
              </div>
              <div className="rounded-lg border p-3">
                <div className="font-semibold">Oversized Fit</div>
                <div className="text-muted-foreground">Silhouette modern</div>
              </div>
            </div>
          </div>
        ...
        <div className="container py-16 grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h3 className="text-2xl md:text-3xl font-bold tracking-tight">
              Product Design yang Dipikirkan Matang
            </h3>
            <p className="mt-3 text-muted-foreground">
              Setiap detail dihitung: pemilihan material, densitas kain,
              konstruksi jahitan, hingga finishing. Tujuannya sederhana — terasa
              nyaman, terlihat rapi, tahan lama.
            </p>
            <ul className="mt-4 space-y-2 text-sm text-muted-foreground list-disc list-inside">
              <li>
                Material premium: cotton combed 24s, linen blend, fleece 330GSM
              </li>
              <li>
                Konstruksi kuat: chain-stitch, rib tebal, bartack di titik rawan
              </li>
              <li>
                Finishing bersih: enzyme/bio-wash, pre-shrunk, colorfast dye
              </li>
            </ul>
          </div>
      ...
      <section id="experience" className="container py-16">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            <div className="inline-block rounded-full border px-3 py-1 text-xs text-muted-foreground">
              Digital Experience
            </div>
            ...
            <p className="mt-3 text-muted-foreground">
              Dari pencarian hingga checkout, kami optimalkan alur agar cepat
              dan jelas. Panduan ukuran yang mudah, foto detail resolusi tinggi,
              dan ringkasan harga transparan.
            </p>
            <div className="mt-6 grid grid-cols-2 gap-3 text-sm">
              <div className="rounded-lg border p-4 bg-background">
                <div className="font-semibold">Filter Pintar</div>
                <div className="text-muted-foreground">
                  Cari produk dengan warna/ukuran
                </div>
              </div>
              <div className="rounded-lg border p-4 bg-background">
                <div className="font-semibold">Keranjang Persisten</div>
                <div className="text-muted-foreground">Tersimpan otomatis</div>
              </div>
              <div className="rounded-lg border p-4 bg-background">
                <div className="font-semibold">Checkout Cepat</div>
                <div className="text-muted-foreground">
                  Ringkas, jelas, aman
                </div>
              </div>
            ...
            <div className="mt-3 rounded-xl border bg-background p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="text-sm font-semibold">
                  Rp {featured[0].price.toLocaleString("id-ID")}
                </div>
              </div>
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6 text-sm">
            <div className="rounded-xl border p-6 bg-background">
              ...
              <p className="text-muted-foreground mt-2">
                Material breathable dan potongan ergonomis untuk aktivitas aktif
                maupun santai.
              </p>
            </div>
            <div className="rounded-xl border p-6 bg-background">
              ...
              <p className="text-muted-foreground mt-2">
                Jahitan kuat, kain berkualitas, dan treatment agar tetap bentuk
                dan warna.
              </p>
            </div>
            <div className="rounded-xl border p-6 bg-background">
              ...
              <p className="text-muted-foreground mt-2">
                Warna netral dan silhouette modern cocok untuk berbagai style.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="pricing" className="container py-16">
        ...
        <p className="text-center text-muted-foreground mt-2 max-w-2xl mx-auto">
          Harga sudah termasuk pajak. Ongkir flat untuk seluruh Indonesia.
          Dapatkan diskon bundle untuk hemat maksimal.
        </p>
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          <div className="rounded-2xl border p-6">
            ...
            <Link to="/product/aurora-tee">
              <Button className="w-full mt-6">Pilih</Button>
            </Link>
          </div>
          <div className="rounded-2xl border p-6 ring-2 ring-primary">
            ...
            <Link to="/products">
              <Button className="w-full mt-6">Belanja Bundle</Button>
            </Link>
          </div>
          <div className="rounded-2xl border p-6">
            <div className="text-sm font-semibold text-muted-foreground">
